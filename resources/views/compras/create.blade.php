...
@section('page-title', 'Nueva Compra de Productos')
...
<form action="{{ route('compras.store') }}" method="POST" id="compraForm" class="space-y-6" enctype="multipart/form-data">
    @csrf
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <select name="proveedor_id" id="proveedor_id_selector" class="form-input" required onchange="filterProductsByProvider()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="fecha_compra" value="{{ date('Y-m-d') }}" class="form-input" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Número de Factura</label>
                            <input type="text" name="numero_factura" class="form-input" placeholder="001-001-0000000">
                        </div>
                        <div class="form-group">
        ...
        <div class="space-y-6">
            <div class="erp-card">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="tasa_cambio" id="tasa_cambio" value="1" step="0.0001" class="form-input" oninput="calculateAll()">
                    </div>
            ...
            <div class="erp-card">
                ...
                <div class="p-4">
                    <textarea name="observaciones" rows="3" class="form-input text-sm" placeholder="Opcional..."></textarea>
                </div>
            </div>
        </div>
    </div>
...
<template id="itemRowTemplate">
    <tr class="item-row border-b border-border/50 hover:bg-surface2/30">
        ...
        <td class="p-2 text-right font-mono font-bold text-accent subtotal-cell">
            0.00
        </td>
        <td class="p-2 w-10">
...
<script>
    ...
    function filterProductsByProvider() {
        ...
        selects.forEach(select => {
            if (select.tomselect) {
                ...
                // Obtenemos los productos del dataset original
                ...
                originalOptions.forEach(opt => {
                    ...
                    if (!proveedorId || optProvId == proveedorId) {
                        ts.addOption({
                            ...
                            descripcion: opt.text.split(' - ')[1],
                            compra: opt.getAttribute('data-compra'),
                            venta: opt.getAttribute('data-venta'),
                            stock: opt.getAttribute('data-stock'),
                            proveedor: optProvId
                        });
                        if (opt.value == currentValue) anyValid = true;
                    }
                });
                
                if (!anyValid) ts.setValue('');
    ...
    function onProductChange(select) {
        ...
        // Buscamos la opción original para extraer los datos
    ...
    function calculateAll() {
        ...
        if (moneda === 'USD') container.style.display = 'none';
    ...
    function filterProductsByProvider() {
        ...
        selects.forEach(select => {
            if (select.tomselect) {
                ...
                // Iterar sobre todas las opciones originales
                ...
                options.forEach(opt => {
                    ...
                    if (!proveedorId || optProvId == proveedorId) {
                        ...
                        if (opt.value == currentValue) currentValid = true;
                    }
                });
                
                if (!currentValid) ts.setValue('');
                ts.refreshOptions(false);
            }
        });
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        fetchRates().then(() => {
            // Inicializar Tom Select del Proveedor
...
{{-- Estilos para Tom Select (UX PRO) --}}
<style>
    ...
    /* Custom columns layout for table items */
